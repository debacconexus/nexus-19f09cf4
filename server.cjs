...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Public Health Coordination Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Individual Health Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "individual_health_record_records";
'use strict';
